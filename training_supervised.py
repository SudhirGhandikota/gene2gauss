...
if __name__ == '__main__':
    ...
    if args.val_file is not None:
        train_edges, val_edges, test_edges, train_labels, val_labels, test_labels = load_test_edges(args.val_file)
        print("\tTraining data size:", train_edges.shape, "Validation data size:", val_edges.shape, "Testing data size:", test_edges.shape)
        print("\t",Counter(train_labels), Counter(val_labels), Counter(test_labels))
    else:
        ...
        print("\tTraining data size:", train_edges.shape, "Validation data size:", val_edges.shape,
              "Testing data size:", test_edges.shape)
        print("\t", Counter(train_labels), Counter(val_labels), Counter(test_labels))
    ...
    #print(outfile_mu, outfile_sigma, metrics_file, plt_file)
...
# python training_supervised.py --inpath /home/aniljegga2/bigdataserver/Sudhir_stuff/networks_gene2gauss/soft_threshold_networks/
...
# --outpath /home/aniljegga2/bigdataserver/Sudhir_stuff/all_g2g_results/gene2gauss_results/gcn